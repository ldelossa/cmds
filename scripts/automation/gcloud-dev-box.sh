...
gcloud compute instances create ldelossa-devel \
    ...
    --create-disk=auto-delete=yes,boot=yes,device-name=ldelossa-devel,image=projects/rocky-linux-cloud/global/images/rocky-linux-9-optimized-gcp-v20240717,mode=rw,provisioned-iops=3060,provisioned-throughput=155,size=60,type=hyperdisk-balanced \
